...
class Landing extends Component {
  ...
  render() {
    const displayLogin = this.state.showSignUp ? (
      <SignUp toggleLogin={this.showLogin} history={this.props.history} />
    ) : (
      <Login toggleSignup={this.showSignUp} history={this.props.history} />
    );
