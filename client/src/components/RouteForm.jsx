...
class RouteForm extends Component {
  constructor(props) {
    ...
    this.handleMethodDescriptionChange = this.handleMethodDescriptionChange.bind(
      this
    );
  ...
  render() {
    const formContainer = {
      position: "absolute",
      top: Math.max(
        this.props.connection.handleY * this.props.canvasHeight + 25,
        0
      ),
              ...
              return (
                <div key={i}>
                  ...
                  <input
                    ...
                    onChange={e => {
                      this.handlePropertyEdit(e, m, method, "description");
                    }}
                  />
                    ...
                    <div>
                      {method.parameters.length > 0 ? (
                        ...
                        <button
                          ...
                          type="button"
                          onClick={() => {
                            this.handleAddParameter(m, method);
                          }}
                        >
                          New Parameter
                        </button>
                      ...
                      {Object.keys(method.responses).length > 0 ? (
                        <div>Responses:</div>
                      ) : (
                        <button
                          type="button"
                          onClick={() => {
                            this.handleAddResponse(m, method);
                          }}
                        >
                          New Response
                        </button>
                          ...
                          <div key={i}>
                            ...
                            <div>
                              <input
                                ...
                                value={method.responses[r].description}
                                onChange={e => {
                                  this.handlePropertyEdit(
                                    e,
                                    m,
                      ...
                      {Object.keys(method.responses).length && (
                        <button
                          type="button"
                          onClick={() => {
                            this.handleAddResponse(m, method);
